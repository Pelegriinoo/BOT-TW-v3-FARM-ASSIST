...
class ResourceManager:
    ...
    def check_state(self):
        ...
        """
        # Criar cópias das chaves para evitar RuntimeError durante modificação
        for source in list(self.requested.keys()):
            for res in list(self.requested[source].keys()):
    ...
    def can_recruit(self):
        ...
        if self.actual["pop"] == 0:
            ...
            # Criar uma cópia das chaves antes de iterar para evitar RuntimeError
            keys_to_check = list(self.requested.keys())
